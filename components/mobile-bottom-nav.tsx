...
import { Home, Wrench, Building2, Phone } from "lucide-react"
...
export function MobileBottomNav() {
  ...
  const handleWhatsApp = () => {
    window.open("https://wa.me/905334798387?text=Merhaba, bilgi almak istiyorum.", "_blank")
  }
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-background border-t border-border safe-area-bottom">
      <div className="flex items-center justify-around h-16 px-2">
        ...
        <button onClick={handleWhatsApp} className="flex flex-col items-center justify-center flex-1 h-full gap-1">
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[#25D366] shadow-lg -mt-4">
