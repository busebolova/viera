...
const servicesData = {
  ...
  hafriyat: {
    ...
    fullDescription:
      "Abdioğlu Group A.Ş. olarak, modern ekipman ve uzman kadromuzla hafriyat ve altyapı çözümleri sunuyoruz. İnşaat projelerinin temelini oluşturan hafriyat çalışmalarını, çevreye duyarlı ve verimli bir şekilde gerçekleştiriyoruz. Altyapı projelerinde ise, uzun ömürlü ve kaliteli çözümler üretiyoruz.",
    icon: "Truck",
...
export const generateMetadata = ({ params }: { params: { slug: string } }) => {
  ...
  return {
    ...
    keywords: ["Abdioğlu Group", "Hizmetler", service.title],
  }
}
          ...
          <div className="w-full md:w-80 lg:w-96">
            <div className="bg-muted/30 rounded-lg p-6 sticky top-24">
              ...
              <div className="mt-8 space-y-4">
                ...
                <Button variant="outline" className="w-full btn-standard" asChild>
                  <a
