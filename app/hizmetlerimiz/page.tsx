  ...
  return (
    <div className="min-h-screen pb-24 md:pb-0">
      ...
      <div className="relative w-full h-[40vh] overflow-hidden">
        ...
        <Image src="/project-1.png" alt="VIERA Hizmetler" fill className="object-cover" priority />
        <div className="absolute inset-0 z-20 flex items-center">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 font-poppins">Hizmetlerimiz</h1>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 gap-6 mb-12 md:hidden">
            <div className="bg-muted/30 rounded-lg border border-zinc-200 dark:border-zinc-800 overflow-hidden">
              <div className="aspect-video relative">
                <Image src="/project-1.png" alt="Konut Projeleri" fill className="object-cover" />
              </div>
              <div className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Modern yaşam standartlarına uygun, konforu ve estetiği bir araya getiren konut projeleri
                  geliştiriyoruz.
                </p>
            ...
            <div className="bg-muted/30 rounded-lg border border-zinc-200 dark:border-zinc-800 overflow-hidden">
              <div className="aspect-video relative">
                <Image src="/project-2.png" alt="Ticari Projeler" fill className="object-cover" />
              </div>
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <div className="h-10 w-10 rounded-full bg-zinc-100 text-zinc-800 dark:bg-zinc-800 dark:text-zinc-100 flex items-center justify-center mr-3">
            ...
            <div className="bg-muted/30 rounded-lg border border-zinc-200 dark:border-zinc-800 overflow-hidden">
              <div className="aspect-video relative">
                <Image src="/project-3.png" alt="Karma Kullanımlı Projeler" fill className="object-cover" />
              </div>
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <div className="h-10 w-10 rounded-full bg-zinc-100 text-zinc-800 dark:bg-zinc-800 dark:text-zinc-100 flex items-center justify-center mr-3">
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold font-poppins">Konut Projeleri</h3>
                </div>
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2 space-y-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold font-poppins">Ticari Projeler</h3>
                </div>
                <p className="text-muted-foreground">
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold font-poppins">Karma Kullanımlı Projeler</h3>
                </div>
                <p className="text-muted-foreground">
          ...
          <div className="mt-12 md:mt-20 bg-muted/30 rounded-lg p-6 md:p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="btn-standard bg-green-600 hover:bg-green-700 text-white" asChild>
                <a
                  href="https://wa.me/905334798387?text=Merhaba%2C%20VIERA%20Construction%20hizmetleri%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum."
                  target="_blank"
